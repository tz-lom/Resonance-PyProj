...
class TestPipeFilter(TestProcessor):
    ...
    def test_trivial(self):
        ...
        self.check_processor([self.si], [db], {'out_0': expected}, resonance.pipe.bit_signal_to_event, bit=0)
    ...
    def test_carry_front_across_blocks(self):
        ...
        self.check_processor([self.si], data, {'out_0': expected}, resonance.pipe.bit_signal_to_event, bit=0,
                             rising_edge='Rise', falling_edge='Fall')
